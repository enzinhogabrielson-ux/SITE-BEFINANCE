...
export default function ContaDemoPage() {
  return (
    <InternalPageLayout
      ...
      subtitle="Pratique sem riscos com $10.000 virtuais. Aprenda a negociar antes de investir dinheiro real."
      cta={{ label: "Abrir conta demo", href: "#" }}
      features={[
        { title: "$10.000 virtuais", description: "Comece com saldo virtual generoso para praticar suas estratégias.", icon: icon("M12 2V22M17 5H9.5C7.57 5 6 6.57 6 8.5S7.57 12 9.5 12H14.5C16.43 12 18 13.57 18 15.5S16.43 19 14.5 19H6") },
